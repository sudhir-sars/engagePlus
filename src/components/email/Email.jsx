...
const Email = () => {
  ...
  const handleNextButtonClick = () => {
    navigate('/emailinput',{ state: inputValue }); // Redirect to the EmailInput component
  };
  ...
  return (
    <div className="bg-slate-200 h-screen">
      ...
      <div className=' flex justify-center bg-slate-200'> 
        <button onClick={handleNextButtonClick} className=' justify-center h-11 w-28 font-mono mt-24 bg-slate-500 text-white text-lg rounded-lg' >Next</button>
        </div>
    </div>
  );
};
